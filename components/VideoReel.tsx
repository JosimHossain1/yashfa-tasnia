...
export const VideoReel = () => {
  ...
  return (
    <section className="py-24 px-6 md:px-12 bg-zinc-900 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
          <div className="max-w-xl">
            <span className="text-xs uppercase tracking-[0.3em] opacity-50 mb-4 block">Motion Portfolio</span>
            <h2 className="font-serif text-5xl md:text-7xl leading-none">Cinematic <br /><span className="italic">Storytelling.</span></h2>
          </div>
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center group-hover:bg-black/20 transition-colors">
            <div className="w-24 h-24 rounded-full border border-white/30 flex items-center justify-center backdrop-blur-sm group-hover:scale-110 transition-transform">
              <Play className="w-8 h-8 fill-white" />
            </div>
          </div>

          <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
            <div className="font-serif text-2xl italic">2024 Showreel</div>
            <div className="text-[10px] uppercase tracking-widest opacity-50">Play Reel (2:45)</div>
          </div>
        </motion.div>
      </div>
